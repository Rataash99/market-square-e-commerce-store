...
const Login = () => {
    ...
    return (
        ...
        <div className='flex flex-col bg-gray-900 text-xs justify-center items-center rounded-xl max-w-sm sm:text-sm md:text-base md:justify-start mx-auto md:mx-[3rem] lg:mx-auto p-4 gap-10'>
            ...
            <form className='flex gap-3 flex-col w-[90%]' action={statusCheck}>
                ...
                <label>
                    <input className='bg-gray-800 p-2 rounded-sm w-full text-yellow-500 cursor-pointer hover:scale-105 hover:text-yellow-400' type='submit'></input>
                </label>
            </form>
            <div className='relative gap-2 flex flex-col w-[90%] items-center'>
                ...
                <Link className='bg-gray-800 p-2 rounded-sm text-center text-cyan-500 hover:text-cyan-400 hover:scale-105 w-full' to='/signup'>Create your Shopperz account</Link>
