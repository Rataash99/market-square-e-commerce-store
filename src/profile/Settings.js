...
const Settings = () => {
    return (
        <section className=' relative flex flex-col gap-2 items-start z-10  justify-center before:bg-slate-800 before:w-full before:h-[20vh] before:content-[""] before:-z-10 before:absolute before:top-0 before:left-0 p-5'>
            ...
            <div className='lower mt-28 space-y-6 pl-3'>
                <div className='space-y-2 flex justify-between gap-3 items-center'>
                    <div className='flex items-center gap-3'>
                        <img className='w-8 inline bg-slate-500 rounded-md' src = {lock}/>
                        <div>
                            <h2>Password</h2>
                            <p className='text-xs sm:text-sm text-slate-400 '>A password keeps your account secure</p>
                        </div>
                    </div>
                    <button className='text-xs bg-slate-800 p-2 text-cyan-500 hover:text-400 rounded-sm'>change</button>
                </div>
                <div className='space-y-2 flex justify-between gap-3 items-center'>
                    <div className='flex items-center gap-3'>
                        <img className='w-8 inline bg-slate-500 rounded-md' src = {phone}/>
                        <div>
                ...
                <div className='space-y-2 flex justify-between gap-3 items-center'>
                    <div className='flex items-center gap-3'>
                        <img className='w-8 inline bg-slate-500 rounded-md' src = {mail}/>
                        <div>
