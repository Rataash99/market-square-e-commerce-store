...
const Header = () => {
    ...
    return (
        <div className=' bg-gradient-to-br from-black via-gray-900 to-black sm:sticky top-0 w-full p-1 px-2 shadow-md z-50 shadow-sky-900 duration-1000 ease-out transition-all'>

            <div className='relative container mx-auto flex justify-between items-center sm:sticky top-0 w-full p-1 px-2 z-50 text-xs text-white duration-1000 ease-out transition-all'>
                <Link to='/'>
